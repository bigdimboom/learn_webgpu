...
async function draw(ctx: WGPUContext, data: RenderData) 
{
    ...
    renderPass.setVertexBuffer(0, data.cube.vbo, 0, data.cube.vertices.byteLength);
    renderPass.setVertexBuffer(1, data.cube.vbo, data.cube.vertices.byteLength, data.cube.normals.byteLength);
